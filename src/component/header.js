...
export default function PersistentDrawerLeft() {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          {open ? (
            ...
            <img
              src={LogoIcon}
              style={{ width: "120px", height: "50px", borderRadius: "5px" }}
            />
          )}
          <IconButton
            color="inherit"
          ...
          >
            <MenuItem
              onClick={() => {
                dispatch(
                  setAccountData({ mail: "", pass: "", permission: "" })
                );
                navigate("/");
              }}
            >
      ...
      >
        <DrawerHeader>
          <img src={LogoIcon} style={{ width: "120px", height: "60px" }} />
          <div style={{ flex: "1" }}></div>
          ...
          {!open ? (
            ...
            >
              <List>
                ...
                <ListItem disablePadding onClick={handleClickCreditlist}>
                  <ListItemButton>
                    <ListItemIcon>
                      <AssignmentReturnedIcon />
                    </ListItemIcon>
