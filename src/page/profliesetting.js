...
export default function ResponsiveGrid() {
  ...
  return (
    ...
    >
      <Box sx={{ color: "red", py: "20px", fontSize: "25px" }}>Profile</Box>
      <Box>
        <Grid
          container
          spacing={{ xs: 2, md: 3 }}
          ...
          <Grid item xs={12} sm={12} md={12}>
            <Item1>
              ...
              >
                ...
                >
                  <Avatar sx={{ width: "120px", height: "120px" }}>CA</Avatar>
                  ...
                  <Grid item xs={12} sm={12} md={12}>
                    ...
                    >
                      <Grid
                        ...
                        sm={6}
                        md={6}
                        sx={{ textAlign: "left", pl: "50px !important" }}
                      >
                        Email
                      </Grid>
                      <Grid
      ...
      <Box sx={{ p: 5, my: 3, bgcolor: "white", borderRadius: "10px" }}>
        This will be updated shortly! NO CASH REFUND - CREDIT REFUND AFTER
        AGREEMENTS -
      </Box>
